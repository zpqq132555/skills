---
name: find-skills-cn
description: 帮助用户在提出诸如“如何做 X”、“寻找处理 X 的技能”、“是否有能够……的技能”之类的问题，或者表达出想要扩展功能的意愿时，发现、筛选并推荐相应的代理技能。当用户正在寻找可能以可安装技能形式存在的功能时，应使用此技能。若用户进一步要求列出可安装技能或执行安装，应转交给 `skill-installer`。
---

# 寻找 Skills

此技能可助您在开放型代理技能生态系统中发现、筛选并推荐各类技能。

本技能负责“找什么技能合适”。
当用户已经决定要安装哪个技能，或明确要求列出可安装技能、执行安装、从 GitHub/仓库路径安装时，应转交给 `skill-installer`。
...
若用户接着说“安装它”“列出能装的技能”“从某个 GitHub 路径安装”，不要在本技能内继续承担安装流程，应改用 `skill-installer`。
